...
public class SpherePhysics : MonoBehaviour
{
    ...
    public float randomForceMagnitude = 5f;  // Adjust the random force applied
    ...
    private void FixedUpdate()
    {
        ...
        velocity.x *= horizontalDamping; // Reduce horizontal x-velocity
        velocity.z *= horizontalDamping; // Reduce horizontal z-velocity
