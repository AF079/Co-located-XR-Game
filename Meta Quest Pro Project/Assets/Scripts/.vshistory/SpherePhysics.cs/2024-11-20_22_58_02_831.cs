...
public class SpherePhysics : MonoBehaviour
{
    ...
    private float jitterIntensity = 1f;
    void Start()
    {
    ...
    void Update()
    {
        ...
        float d = Vector3.Distance(simulatedPosition, rb.position);
        rb.position = Vector3.Lerp(rb.position, simulatedPosition, Time.deltaTime *d );
        Debug.Log(d);
