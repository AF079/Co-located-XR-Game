...
public class JoinGameManager : MonoBehaviourPunCallbacks
{
    ...
    public void Start()
    {
        ...
        try
        {
            ...
            PhotonNetwork.NetworkingClient.LoadBalancingPeer.NetworkSimulationSettings.IncomingLossPercentage = 20; // 5% packet loss
            PhotonNetwork.NetworkingClient.LoadBalancingPeer.NetworkSimulationSettings.OutgoingLossPercentage = 20; // 5% packet loss
        }
