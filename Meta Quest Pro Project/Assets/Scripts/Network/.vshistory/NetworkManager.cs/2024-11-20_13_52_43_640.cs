...
/*
    ...
    private IEnumerator SimulateLatencyForNMC()
    {
        ...
        while (true)
        {
            ...
            if (rand > 50)
            {
                PhotonNetwork.NetworkingClient.LoadBalancingPeer.NetworkSimulationSettings.IncomingJitter = 50; // 20ms jitter
                PhotonNetwork.NetworkingClient.LoadBalancingPeer.NetworkSimulationSettings.OutgoingJitter = 50; // 20ms jitter
                ...
                photonPeer_.NetworkSimulationSettings.OutgoingLag = 50;
                photonPeer_.NetworkSimulationSettings.IncomingLag = 50;
