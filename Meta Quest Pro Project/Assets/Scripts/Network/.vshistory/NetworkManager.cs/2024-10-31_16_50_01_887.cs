...
/*        if (PhotonNetwork.IsConnected && PhotonNetwork.InRoom && PhotonNetwork.IsMasterClient)
    ...
    private void move(Transform t)
    {
        ...
        /*        // Step 1: Translate to make t relative to B’s origin in A’s space
                ...
                // Step 2: Define the forward and up directions for B in A’s space
                Vector3 vu = (r_upBinA - r_originBinA).normalized;       // Up vector for B
                Vector3 vf = (r_forwardBinA - r_originBinA).normalized;  // Forward vector for B
                ...
                // Step 5: Update the transform position
                t.position = new Vector3(newPos.x, newPos.y, newPos.z);*/
    }
