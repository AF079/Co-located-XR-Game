...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    private async void spawnBalls()
    {
        for (var i = 0; i < numberOfBalls; i++)
        {
            ...
            StartCoroutine(AnchorCreatedAndSave(anchor));
    ...
    private IEnumerator AnchorCreatedAndSave(OVRSpatialAnchor anchor)
    {
        ...
        yield return StartCoroutine(WaitForTask(SaveAnchor(anchor)));
