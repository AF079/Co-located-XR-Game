...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    private float TrilinearInterpolation(float x, float y, float z, float u, float v, float w, float pMax, float pMin, Vector3[] points)
    {
        
    }
    private Vector3 getInterpolatedPoint()
    {
        ...
        Vector3[] points = { p000, p111, p100, p010, p110, p001, p101, p011 };
    }
