...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public static int IN_JITTER = 5; 
    public static int OUT_JITTER = 5;
    //Lag: delay between sending a packet of data from source to target
    public static int IN_LOSS_CHANCE = 10;
    public static int OUT_LOSS_CHANCE = 10;
    ...
    private IEnumerator SimulateLatencyForNMC()
    {
        ...
        while (true)
        {
            ...
            if (rand > 50)
            {
                ...
                PhotonNetwork.NetworkingClient.LoadBalancingPeer.NetworkSimulationSettings.OutgoingLag = OUT_LOSS_CHANCE;
            ...
            {
                PhotonNetwork.NetworkingClient.LoadBalancingPeer.NetworkSimulationSettings.IncomingLag = 0;
