...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public static float IN_JITTER = 5f;
    public static float OUT_JITTER = 5f;
    public static float IN_LOSS_CHANCE = 10f;
    public static float OUT_LOSS_CHANCE = 10f;
...
/*
    ...
    private IEnumerator SimulateLatencyForNMC()
    {
        ...
        while (true)
        {
            ...
            if (rand > 50)
            {
               PhotonNetwork.NetworkingClient.LoadBalancingPeer.NetworkSimulationSettings.IncomingJitter = 5; 
                PhotonNetwork.NetworkingClient.LoadBalancingPeer.NetworkSimulationSettings.OutgoingJitter = 5; 
