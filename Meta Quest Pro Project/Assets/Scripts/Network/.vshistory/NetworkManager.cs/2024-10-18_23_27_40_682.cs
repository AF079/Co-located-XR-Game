...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    private IEnumerator test()
    {
        ...
        while (i < 10)
        {
            ...
            Debug.Log("Setting new position: " + i + " " + randomPosition);
            LeftEye.transform.position = randomPosition;
            CenterEye.transform.position = randomPosition;
            RightEye.transform.position = randomPosition;

            LeftHand.transform.position = randomPosition;
            RightHand.transform.position = randomPosition;
            yield return new WaitForSeconds(5f);
            Debug.Log("Finished waiting, on to new position");
            i++;
        }
