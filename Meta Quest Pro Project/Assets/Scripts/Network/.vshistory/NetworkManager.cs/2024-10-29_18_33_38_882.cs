...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    private void move(Transform t)
    {
        ...
        Debug.DrawLine(r_originBinA,u, new Color(1,0,0));

        Vector3 v = (r_upBinA - r_originBinA).normalized;
        Debug.DrawLine(Vector3.zero, v, new Color(0, 1, 0));

        //Vector3 v_ = (new Vector3(r_originBinA.x, r_originBinA.y + 1, r_originBinA.z) - r_originBinA).normalized; // 1 also try r_originBinA.z instead of r_upBinA.z , 2 new Vector3(r_originBinA.x,r_upBinA.y, r_originBinA.z)
        //Debug.DrawLine(Vector3.zero, v_, new Color(0, 0, 1));*/
        Vector3 v_ = (new Vector3(r_originBinA.x, r_originBinA.y + 1, r_originBinA.z)).normalized;//Vector3.up;
