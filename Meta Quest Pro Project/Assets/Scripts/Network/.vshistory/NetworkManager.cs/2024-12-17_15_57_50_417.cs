    ...
    private IEnumerator SimulateLatencyForNMC()
    {
        ...
        while (true)
        {
            ...
            if (rand > 50)
            {
                ...
                photonPeer_.NetworkSimulationSettings.OutgoingLag = OUT_LOSS_CHANCE;
                photonPeer_.NetworkSimulationSettings.IncomingLag = IN_LOSS_CHANCE;
