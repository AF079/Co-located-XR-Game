...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public void DeactivateSphere(string sphereTag)
    {
        ...
        if (sphere != null)
        {
            sphere.SetActive(false);  // Deactivate sphere on all clients
        }
    }
    ...
    {
        if (PhotonNetwork.IsConnected && PhotonNetwork.InRoom && PhotonNetwork.IsMasterClient && PhotonNetwork.PlayerList.Length == 2)
        {
