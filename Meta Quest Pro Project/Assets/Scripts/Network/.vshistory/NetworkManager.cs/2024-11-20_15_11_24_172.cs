...
*/
    ...
    private IEnumerator SimulateLatencyForNMC()
    {
        ...
        while (true)
        {
            ...
            if (rand > 50)
            {
                PhotonNetwork.NetworkingClient.LoadBalancingPeer.NetworkSimulationSettings.IncomingJitter = 15; // 20ms jitter
                PhotonNetwork.NetworkingClient.LoadBalancingPeer.NetworkSimulationSettings.OutgoingJitter = 15; // 20ms jitter
                photonPeer_.NetworkSimulationSettings.OutgoingLag = 75;
                photonPeer_.NetworkSimulationSettings.IncomingLag = 75;
