...
/*
    ...
    private IEnumerator SimulateLatency()
    {
        while (true)
        {
            ...
            if (rand > 50)
            {
                PhotonNetwork.NetworkingClient.LoadBalancingPeer.NetworkSimulationSettings.IncomingLag = 70;

                string logEntry = $"{DateTime.Now:HH:mm:ss.fff}, Simulated Latency: 70ms";
