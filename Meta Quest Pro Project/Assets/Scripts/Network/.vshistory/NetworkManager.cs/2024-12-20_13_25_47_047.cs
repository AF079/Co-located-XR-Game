    ...
    */
    ...
    private IEnumerator SendRegisteredPoints()
    {
        ...
        photonView_.RPC("sendTransformData", RpcTarget.Others,
            ...
            rightBinA.x, rightBinA.y, rightBinA.z,
    ...
    private void registerPoints()
    {
        if (OVRInput.GetDown(OVRInput.Button.PrimaryIndexTrigger, OVRInput.Controller.RTouch))
        {
            ...
            {
                rightBinA = OVRInput.GetLocalControllerPosition(OVRInput.Controller.RTouch);
                p3Txt.text = "Side(x): " + rightBinA;
                regP3 = true;
            }
            else if (!regP4)
            {
    ...
    private void autoRegisterPoints()
    {
        ...
        if (!regP3)
        {
            rightBinA = -Vector3.right;
            p3Txt.text = "Right(x) Anchor Point: " + rightBinA;
            regP3 = true;
        }
                                    ...
                                    float fx, float fy, float fz)
    {
        ...
        rightBinA = new Vector3(sx, sy, sz);
