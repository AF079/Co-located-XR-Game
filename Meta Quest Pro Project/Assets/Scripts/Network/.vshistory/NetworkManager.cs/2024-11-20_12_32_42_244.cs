...
/*
    ...
    private IEnumerator spawnBalls()
    {
        for (var i = 0; i < numberOfBalls; i++)
        {
            ...
            Vector3 randomOffset = new Vector3(UnityEngine.Random.Range(-1f, 1f), UnityEngine.Random.Range(0f, 2f), UnityEngine.Random.Range(-1f, 1f));
    ...
    /*private IEnumerator SimulateLatencyForMC()
    {
        while (!spawnedBalls)
        {
            yield return null;
        ...
        while (true)
        {
            ...
            if (rand > 50)
            {
                ...
                {
                    sphere.GetComponent<NetworkedSphere>().simulateLatency();
                }
            }
        }
    }*/
    ...
    private IEnumerator SimulateLatencyForNMC()
    {
        ...
        while (true)
        {
            ...
            if (rand > 50)
            {
                PhotonNetwork.NetworkingClient.LoadBalancingPeer.NetworkSimulationSettings.IncomingJitter = 100; // 20ms jitter
                PhotonNetwork.NetworkingClient.LoadBalancingPeer.NetworkSimulationSettings.OutgoingJitter = 100; // 20ms jitter
                ...
                photonPeer_.NetworkSimulationSettings.OutgoingLag = 300;
                photonPeer_.NetworkSimulationSettings.IncomingLag = 300;
