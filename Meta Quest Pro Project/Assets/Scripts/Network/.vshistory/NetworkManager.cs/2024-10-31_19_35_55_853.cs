...
/*        if (PhotonNetwork.IsConnected && PhotonNetwork.InRoom && PhotonNetwork.IsMasterClient)
    ...
    private Vector3 MatMul(float[,] m1, float[,] m2)
    {
        // Ensure m1 is 3x3 and m2 is 3x1
        if (m1.GetLength(0) != 3 || m1.GetLength(1) != 3 || m2.GetLength(0) != 3 || m2.GetLength(1) != 1)
        {
        ...
        float x = m1[0, 0] * m2[0, 0] + m1[0, 1] * m2[1, 0] + m1[0, 2] * m2[2, 0];
        float y = m1[1, 0] * m2[0, 0] + m1[1, 1] * m2[1, 0] + m1[1, 2] * m2[2, 0];
        float z = m1[2, 0] * m2[0, 0] + m1[2, 1] * m2[1, 0] + m1[2, 2] * m2[2, 0];
