...
/*        if (PhotonNetwork.IsConnected && PhotonNetwork.InRoom && PhotonNetwork.IsMasterClient)
    ...
    private IEnumerator Wait()
    {
        ...
        Debug.Log("SENDING TRANSFOR DATA");
...
*/
    ...
    private Vector3 changePosition(GameObject go)
    {
    ...
    private void repositionSpheres()
    {
        ...
        if (spheres.Length == numberOfBalls) {
            ...
            Debug.Log("BEFORE CENTER EYE " + CenterEye.transform.position + " " + CenterEye.transform.rotation);
            Vector3 v1 = changePosition(LeftEye);
            Vector3 v2 = changePosition(RightEye);
            Vector3 v3 = changePosition(LeftHand);
            Vector3 v4 = changePosition(RightHand);
            Vector3 v5 = changePosition(CenterEye);
            Vector3 v6 = changePosition(cube);
            LeftEye.transform.position = new Vector3(v1.x, v1.y, v1.z);
            RightEye.transform.position = new Vector3(v2.x, v2.y, v2.z);
            LeftHand.transform.position = new Vector3(v3.x, v3.y, v3.z);
            RightHand.transform.position = new Vector3(v4.x, v4.y, v4.z);
            CenterEye.transform.position = new Vector3(v5.x, v5.y, v5.z);
            Debug.Log("AFTER CENTER EYE " + CenterEye.transform.position + " " + CenterEye.transform.rotation);
            cube.transform.position = new Vector3(v6.x, v6.y, v6.z);
