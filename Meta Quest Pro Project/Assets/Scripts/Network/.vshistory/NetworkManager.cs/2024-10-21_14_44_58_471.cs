...
/*        if (OVRInput.GetDown(OVRInput.Button.PrimaryIndexTrigger, OVRInput.Controller.RTouch))
    ...
    private void repositionSpheres()
    {
        ...
        if (spheres.Length == numberOfBalls) {
            ...
            Vector3 dirB = p2 - p1;
            Quaternion rot = Quaternion.FromToRotation(new Vector3(0, 0, 0), rp1);//Quaternion.FromToRotation(dirB, dirA);
            foreach (GameObject sphere in spheres)
            {
                ...
                sphere.transform.position += rp1; /*rot * (sphere.transform.position - p1) + rp1;*/
