...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    private int numberOfBallsLeft = 1;
...
/*
    ...
    private IEnumerator spawnBalls()
    {
        for (var i = 0; i < numberOfBalls; i++)
        {
            ...
            Vector3 randomOffset = new Vector3(UnityEngine.Random.Range(-0.03f, 0.03f), UnityEngine.Random.Range(0f, 3f), UnityEngine.Random.Range(0, 0.03f));
