...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    {
        Debug.Log("BEFORE LEFT EYE: " + LeftEye.transform.position);
        Debug.Log("BEFORE RIGHT EYE: " +  RightEye.transform.position);
        Debug.Log("BEFORE CENTER EYE: " + CenterEye.transform.position);
        Debug.Log("BEFORE LEFT HAND: " + LeftHand.transform.position);
        Debug.Log("BEFORE RIGHT HAND: " + RightHand.transform.position);
        ...
        Debug.Log("AFTER LEFT EYE: " + LeftEye.transform.position);
        Debug.Log("AFTER RIGHT EYE: " + RightEye.transform.position);
        Debug.Log("AFTER CENTER EYE: " + CenterEye.transform.position);
        Debug.Log("AFTER LEFT HAND: " + LeftHand.transform.position);
        Debug.Log("AFTER RIGHT HAND: " + RightHand.transform.position);
