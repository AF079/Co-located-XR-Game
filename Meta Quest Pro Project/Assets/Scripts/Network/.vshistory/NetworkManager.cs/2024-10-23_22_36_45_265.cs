...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    private Vector3[] sphereCoordinates;
    private Vector3[] receivedSphereCoordinates;
    private int sphereIdx;
    ...
    {
        sphereIdx = 0;
        receivedSphereCoordinates = new Vector3[numberOfBalls];
        sphereCoordinates = new Vector3[numberOfBalls];
