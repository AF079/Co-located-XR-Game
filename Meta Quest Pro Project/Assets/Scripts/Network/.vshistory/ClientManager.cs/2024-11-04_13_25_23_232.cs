...
public class ClientManager : MonoBehaviourPunCallbacks
{
    ...
    private void moveSpheres()
    {
        ...
        origin.transform.position = Vector3.zero; // move(origin.transform);
        up.transform.position = Vector3.zero; //move(up.transform);
        side.transform.position = Vector3.zero; //move(side.transform);
        forward.transform.position = Vector3.zero; //move(forward.transform);
        someCube.transform.position = Vector3.zero;// move(someCube.transform);
