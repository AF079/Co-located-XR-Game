...
public class NetworkedSphere : MonoBehaviour, IPunOwnershipCallbacks, IPunObservable
{
    ...
    void Awake()
    {
        ...
        /*if (PhotonNetwork.IsMasterClient)
        {
            ...
            photonView.RPC("SendSpawnPositions", RpcTarget.Others, rotatedPosition.x, rotatedPosition.y, rotatedPosition.z);
  ...
  /*  [PunRPC]
    void SendSpawnPositions(float x, float y, float z)
    {
