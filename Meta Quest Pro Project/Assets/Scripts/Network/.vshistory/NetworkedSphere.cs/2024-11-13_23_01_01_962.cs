        ...
        if (PhotonNetwork.IsMasterClient && !photonView.IsMine)
        {
            ...
            if (stream.IsWriting)// && prevSentPos != transform.position
            {
                if (PhotonNetwork.IsMasterClient)
                {
                    ...
                    Vector3 localVelocity = rb.velocity - NetworkManager_test.originBinA;

                    Vector3 rotatedVelocity = NetworkManager_test.MatMul(transformationMatrix_AtoB, localVelocity);
                    ...
                    Vector3 localVelocity = rb.velocity + NetworkManager_test.originBinA;
                    Vector3 rotatedVelocity = NetworkManager_test.MatMul(transformationMatrix_BtoA, localVelocity);
