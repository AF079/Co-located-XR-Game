...
public class NetworkedSphere : MonoBehaviour, IPunOwnershipCallbacks
{
    ...
    public float pushForceMutliplier = 3f;
    ...
    void Update()
    {
        if (rb.transform.position.y <= -4.0f || rb.transform.position.y >= 20.0f || rb.transform.position.x <= -20.0f || rb.transform.position.x >= 20.0f)
        {
