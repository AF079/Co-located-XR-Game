...
public class NetworkManager_test : MonoBehaviourPunCallbacks
{
    ...
    private IEnumerator spawnBalls()
    {
        for (var i = 0; i < numberOfBalls; i++)
        {
            ...
            sphere.GetComponent<NetworkedSphere>().spawnPoint = randomPosition; 
    ...
    public static Vector3 move(Transform t)
...
//                StartCoroutine(repositionSpheres());
                ...
                if (spheres.Length == numberOfBalls)
                {
                    ...
                    /*foreach (GameObject sphere in spheres)
                    {
                        ...
                        sphere.GetComponent<NetworkedSphere>().reqOwnershipForMove(newPos);
                    }*/
                   /* foreach (GameObject sphere in spheres)
                    {
